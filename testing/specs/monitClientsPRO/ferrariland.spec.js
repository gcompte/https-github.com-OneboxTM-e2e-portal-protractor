...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.json').ferrariland;


describe('QAA-1403 Port Aventura - Ferrari Land - 1 día 2 parques', function() {
    var venueNoMapPO = new VenueNoMapPO(),
    ...
    it('Verificamos que la localidad aparece correctamente en el summary', function(){
        ...
        expect(summaryPO.getNumberSeatsSelected()).toEqual('Entradas (2)');
