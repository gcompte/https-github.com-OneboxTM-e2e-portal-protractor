...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.' + env + '.json').qa2563;

describe('QA-2563 Promoción descuento con recargos alternativos de organizador y de canal - Incentivo porcentual', function() {
    beforeAll(function() {
