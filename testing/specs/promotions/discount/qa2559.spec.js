...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.' + env + '.json').qa2559;

describe('QA-2559 Promoción descuento con recargos alternativos de organizador y de canal - Incentivo Fijo', function() {
    beforeAll(function() {
