...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.' + env + '.json').qa2575;

describe('QA-2575 Promoción promoción con recargos alternativos de organizador y de canal - Incentivo Porcentual', function() {
    beforeAll(function() {
