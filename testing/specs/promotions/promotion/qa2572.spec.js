...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.' + env + '.json').qa2572;

describe('QA-2572 Promoción promoción sin recargos alternativos - Incentivo Fijo', function() {
    beforeAll(function() {
        browser.get(browser.baseUrl + qaData.sessionUrl);
    });

    it('Accedemos a la selección de localidades de una sesión que tenga una promoción de tipo promoción activa y seleccionamos una localidad', function() {
