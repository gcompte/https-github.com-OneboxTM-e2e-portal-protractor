...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.' + env + '.json').qa2576;

describe('QA-2576 Promoción promoción sin recargos alternativos - Incentivo Porcentual', function() {
    beforeAll(function() {
        browser.get(browser.baseUrl + qaData.sessionUrl);
    });

    it('Accedemos a la selección de localidades de una sesión que tenga una promoción tipo promoción activa y seleccionamos una localidad', function() {
