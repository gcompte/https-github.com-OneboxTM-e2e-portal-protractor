...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.' + env + '.json').qa824;

describe('QA-824 Aplicar Descuento de código promocional bloqueante con restricción de Mínimo de entradas para aplicar a la totalidad de la compra con incentivo fijo', function() {
    beforeAll(function() {
