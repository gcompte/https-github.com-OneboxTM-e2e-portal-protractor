...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.' + env + '.json').qa821;

describe('QA-821 Aplicar Promoción de código promocional con restricción de Mínimo de entradas para aplicar a la totalidad de la compra con incentivo fijo', function() {
    beforeAll(function() {
    ...
    it('Verificamos que existe el campo para insertar el código pero que no es aplicable', function(){
        browser.driver.sleep(2000);
