...
var env = browser.params.env,
    ...
    qaDataActTest = qaData.qa727;

describe('QA-727 Actualización de contador de usos de un descuento con Limite máximo por sesión al liberar localidades por navegar a otra sesión', function() {
    beforeAll(function() {
