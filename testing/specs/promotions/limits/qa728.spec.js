...
var env = browser.params.env,
    ...
    qaDataActTest = qaData.qa728;

describe('QA-728. Actualización de contador de usos de una promoción descuento con Limite máximo por sesión y para toda la promoción al liberar localidades por navegar a otra sesión', function() {
    beforeAll(function() {
