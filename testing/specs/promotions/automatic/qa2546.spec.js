...
var env = browser.params.env,
    ...
    qaData = require('./suite-data.' + env + '.json').qa2546;

describe('QA-2546 Promoción automática con recargos alternativos de organizador y de canal - Incentivo Fijio', function() {
    beforeAll(function() {
