...
var env = browser.params.env,
    qaData = require('./suite-data.' + env + '.json').qa862;

describe('QA-862 [Desktop] Vista en eventos con varios recintos, 1 a 4 ses/día y 1 ses/recinto = Lista Simple, Calendario y Mapa', function() {
    beforeAll(function() {
        browser.get(browser.baseUrl + qaData.eventUrl);
    });

    it('Accedemos a la ficha de un evento y verificamos que tiene disponibles la vista lista y la vista calendario (activa)', function() {
